...
#get market data
data_ir_rub = pd.read_excel('/Users/mihailzaytsev/Desktop/Диссер_мага/rub_ir.xlsx', engine='openpyxl')
data_ir_rub['tradedate'] = pd.to_datetime(data_ir_rub['tradedate']).dt.date
data_ir_usd = pd.read_excel('/Users/mihailzaytsev/Desktop/Диссер_мага/usd_ir.xlsx', engine='openpyxl')
data_ir_usd['tradedate'] = pd.to_datetime(data_ir_usd['tradedate']).dt.date
data_fx = pd.read_excel('/Users/mihailzaytsev/Desktop/Диссер_мага/fx_rates.xlsx', engine='openpyxl')
...
df_log_returns.replace([np.inf, -np.inf], np.nan, inplace=True)
